...
for subj = 1:N  %37:N % for each Participant after soft launch
    ...
    try
        ...
        for ii = 1
            ...
            value_day7_c1 = str2num(cell2mat(data(ii+1,comp1_day7)));
            actual_day7_c1 = 16;
            ...
            value_day12_c1 = str2num(cell2mat(data(ii+1,comp1_day12)));
            actual_day12_c1 = 68;
            ...
            value_day7_c2 = str2num(cell2mat(data(ii+1,comp2_day7)));
            actual_day7_c2 = 34;
            ...
            value_day12_c2 = str2num(cell2mat(data(ii+1,comp2_day12)));
            actual_day12_c2 = 145;
            ...
            value_day7_c3 = str2num(cell2mat(data(ii+1,comp3_day7)));
            actual_day7_c3 = 75;
            ...
            value_day12_c3 = str2num(cell2mat(data(ii+1,comp3_day12)));
            actual_day12_c3 = 86;
            ...
            value_day7_c4 = str2num(cell2mat(data(ii+1,comp4_day7)));
            actual_day7_c4 = 101;
            ...
            value_day12_c4 = str2num(cell2mat(data(ii+1,comp4_day12)));
            actual_day12_c4 = 115;
